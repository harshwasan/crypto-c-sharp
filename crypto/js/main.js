 ...
 *
 */
if (window.location.href.indexOf('?symbol') > 0) {
...
function load_token_metadata(symbol) {
    ...
    $.ajax({
        type: 'GET',
        url: 'https://api.nomics.com/v1/currencies?key=5481aac3a6152007bb6524f6ddfa6d40&ids=' + symbol,
        success: function (data) {
...
function load_token_ticker_data(symbol) {
    ...
    $.ajax({
        type: 'GET',
        url: 'https://api.nomics.com/v1/currencies/ticker?key=5481aac3a6152007bb6524f6ddfa6d40&ids=' + symbol,
        success: function (data) {
